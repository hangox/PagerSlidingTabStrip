...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextSizePx = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, tabTextSizePx, dm);
        ...
        tabPaddingHorizontal = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabPaddingLeftRight, tabPaddingHorizontal);
        tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsTabBackground, tabBackgroundResId);
        shouldExpand = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsShouldExpand, shouldExpand);
        scrollOffset = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsScrollOffset, scrollOffset);
        tabTextSizePx = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTextSize,
                tabTextSizePx);
        tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTextColor,tabTextColor);
        tabTextFocusColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsFocusColor,
                tabTextFocusColor);
        a.recycle();
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                tab.setTextSize(TypedValue.COMPLEX_UNIT_PX, tabTextSizePx);
    ...
    private class PageListener implements OnPageChangeListener {
        ObjectAnimator tabUnfocus, tabFocus;
...
//            Log.i(TAG, " : " + positionOffsetPixels);
    ...
    public int getTabTextFocusColor() {
        return tabTextFocusColor;
    }
    ...
    public void setTabTextSizePx(int tabTextSizePx) {
        this.tabTextSizePx = tabTextSizePx;
        updateTabStyles();
    }
    ...
    public void setTabPaddingHorizontal(int paddingPx) {
        this.tabPaddingHorizontal = paddingPx;
        updateTabStyles();
    }
